...
class controller extends system {
	...
	protected function _base(){
		...
		if (!$dados['logo'] || strpos($dados['logo'], 'logo_meganet.jpg') === false) {
			$dados['logo'] = PASTA_CLIENTE . 'img_logo/logo_meganet.jpg';
		}
		...
		if (empty($dados['imagem']['159432484772768'])) {
			$dados['imagem']['159432484772768'] = PASTA_CLIENTE . 'img_logo/logo_meganet.jpg';
		}
