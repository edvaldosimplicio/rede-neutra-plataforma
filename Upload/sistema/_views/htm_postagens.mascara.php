					...
					<div class="col-xs-12">
						<section class="panel">
							<form action="<?=$_base['objeto']?>mascara_grv" class="form-horizontal" method="post" enctype="multipart/form-data" > 
								...
								<div style="margin-bottom: 0px; font-size: 15px; margin-left: 15px; margin-top: 15px;">Selecione a marca d'agua que deseja adicionar automaticamente as imagens das proximas postagens.</div>
