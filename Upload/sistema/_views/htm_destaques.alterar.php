             ...
             <form action="<?=$_base['objeto']?>alterar_grv" class="form-horizontal" method="post">  						
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-md-12">Setor <?=ajuda('Grupo da imagem, não é possível alterar.');?></label>
                  <div class="col-md-6">
               ...
               <div class="form-group">
                <label class="col-md-12" >Endereço <?=ajuda('Link de destino quando clicar na imagem (opcional).')?></label>
                <div class="col-md-7">
        ...
        <div id="imagem" class="tab-pane <?php if($aba_selecionada == "imagem"){ echo "active"; } ?>" >
          ...
          <?php } else { ?>
            ...
            <div style="text-align:left;">
              <img src="<?=PASTA_CLIENTE?>img_destaques/<?=$data->imagem?>" style="max-width:300px;" >
            </div>
