								...
								<div class="box-body">
									...
									<div>
										...
										<?php if(!$aniversariantes){ ?>
											...
											<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>exportar';">Exportar E-mails</button>

											<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>aniversariantes';">Aniversariantes do Mês</button>
											
										<?php } else { ?>

											<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>exportar_aniversariantes';">Exportar E-mails</button>

											<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>';">Mostrar Todos</button>
